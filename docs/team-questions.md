...
**The question.** When a guest changes a booking — new dates, an extra night, an extra guest — do you edit the existing booking in eZee ('Amend Stay'), or cancel it and create a new one? And when you agree a change with a guest on WhatsApp, is eZee updated straight away, or later, or sometimes not at all? Could you amend one test booking so we can watch whether the change actually reaches us?
