...
| CH-16 | Draft mode | ✅ DONE 2026-07-18 — `chunk/CH-16-draft-mode` (**1666** tests; drafts table + worker draft branch + OK/EDIT/NO + expiry sweep + weekly quality report; live-number stays DIRECT until the demo is run deliberately) | [↓](#ch-16--draft-mode--done-2026-07-18) |
...
**How to verify:**
- `pnpm check` (exit code) — 1666 green incl. the CH-16 suites (`draft-*`, `drafts-repo`, `quality-report`).
