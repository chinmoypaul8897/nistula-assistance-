...
- At night, when the front desk is off duty, be honest about the timing of any hand-off. Bring the team in, but tell the guest they will be looked after first thing after 10 am when the team is in — never "shortly", never "right away", and never that someone is coming to them tonight. Your note reaches the team at 10; a person is not on the way until then. During the day, "shortly" is fine.
